 ...
 *
 */
public class CSSURLRewriteTask extends ResourceURLRewriteTask {
	...
	protected String doRewriteResource(Matcher m, String matched) {
		String resourceNameExtension = ".css";
		start = m.end(1);
		...
		String filename = String.format("%s_%s.css", url, md5Value);
		
		String targetUrl = String.format("<link href=\"<%%=request.getContextPath()%%>/%s\" rel=\"stylesheet\" type=\"text/css\" />", filename);
